...
with open(r"c:\development\silachomka\src\data\releases.js", "r", encoding="utf-8") as f:
    content = f.read()

# 1. Modify createRelease arguments
old_args = """  platforms = {},
  tracks = [],
}) => {"""
new_args = """  platforms = {},
...
# 2. Modify createRelease return object
old_return = """    platforms: {
      ...platforms,
    },"""
new_return = """    type: type || (tracks.length <= 2 ? "single" : "ep"),
    artist,
    featsSilachomka,
...
# 3. Modify description in createRelease
...
with open(r"c:\development\silachomka\src\data\releases.js", "w", encoding="utf-8") as f:
    f.write(content)
